...
use Gecche\Cupparis\App\Geografiche\Models\CupGeoAreaMondiale;
use Gecche\Cupparis\App\Geografiche\Models\CupGeoContinente;
use Gecche\Cupparis\App\Geografiche\Models\CupGeoNazione;
...
class CupGeoNazioniIstat extends BreezeDatafileProvider
{
    /*
...
//        'endingColumn' => 'K',
    ...
    public function formatRow(BreezeDatafileInterface $modelDatafile)
    {
        ...
        $area = CupGeoAreaMondiale::where('codice', $codiceArea)->firstOrCreate(
            [
                'codice' => $codiceArea,
                'nome' => $modelDatafile->nome_area_it
            ]
        );
        ...
        $continente = CupGeoContinente::where('codice', $codiceContinente)->firstOrCreate(
            [
                ...
                'nome' => $modelDatafile->nome_continente_it,
            ]
        );
